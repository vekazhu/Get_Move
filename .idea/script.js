...
redips.init = function () {
	...
	rd.event.dropped = function () {
		...
		if (rd.td.target !== rd.td.source) { 
			redips.printMessage('Exercise plan has been changed!');
		}
	...
	rd.event.deleted = function () {
		redips.printMessage('You just removed an exercise!');
		// show / hide report buttons
		redips.reportButton();
	};
...
// redips.report = function (exercise) {
...
// 		setTimeout(function () {
// 			alert('Number of found exercises: ' + num + '\n' + str);
// 		}, 200);
// 	}
// };
...
// function show all exercises in timetable
