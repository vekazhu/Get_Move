            ...
            <div class="container" >     
                <div class="text-center">
                    <h1 class="section-title-big">Break Time</h1>     
                     <p class="section-text">Taking rest breaks during work can help to prevent leg swelling or fatigue and also decrease the risks of long-term symptom such as varicose veins.</p>
                </div><!-- /.text-center -->
                ...
                <div class="row"> <h4 style="padding: 20px;line-height: 1.6;color:#808080;text-align: justify"> To control for the deleterious effects of prolonged standing, some researchers recommend standing no more than 30% of a typical eight-hour workday for any worker. The Occupational Health Centre for Ontario Workers recommends limiting prolonged standing for pregnant workers to two hours, and floor matting should be provided. </h4>

<h4 style="padding: 0px 22px  22px 22px;line-height: 1.6;color:#808080;text-align: justify"> Seated breaks might reduce the potential for injury to the back from spinal loading. Besides, stretching and relaxing muscles hourly will facilitate reduction of stress and strain from awkward postures.
</h4></div>
                <div class="row"> 
                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4" style="vertical-align: text-top">
                                                       
                                                            <form class="form-horizontal" action="breaktime.php" method="post">
                                                                <h3 class="section-title-small text-center ">Set  Break Time</h3>
                                                                 <p class="text-center">Alerts are sent from 9.00 AM to 05.00 PM (MON-FRI).</p> 
                                                                 <?php include('error2.php')?>
                                                                <div class="row">
                                                                    
                                                                    <div class="col-sm-12">
                                                                        <p><b>Your Email:</b> <?php echo $_SESSION['email']?> </p>
                                                                        <p><b>Choose Time:</b></p>
                                                                        <div class="radio-btn">
                                                                            <?php if ($timebreak == 30) { ?>
