          ...
          document.getElementById("radio-btn5").onclick = function() { 
           ...
           document.getElementById("radio-btn6").onclick = function() { 
            ...
            <div class="tab-pane fade" id="htab2">
              <div class="row"> <h4 style="padding: 20px;line-height: 1.6;color:#808080;text-align: justify">Build in a pattern of creating greater movement variety in the workplace. Muscles can become stiff and painful as you stand or walk all day. Movement is important to get blood circulation through the muscles.</h4></div>
              <div>
                    ...
                    <!-- Begin 2. Exercise at work -->
                     ...
                     <div class="blog-post" style="text-align: center">
                             ...
                             <h3>Exercise3 : XXXXXXXXXXXXXXXXX</h3>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="team-member">
                                            ...
                                            <div class="team-member-info">
                                                ...
                                                <h3 >Walking</h3>
                                                <p class="team-member-text" style="line-height: 1.6;text-align: justify">Going for a walk is highly beneficial and usually safe for people of all ages and fitness levels. Regular walks can help you lose weight, maintain a healthy blood pressure, and strengthen your bones and muscles.</p>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="team-member">
                                            ...
                                            <div class="team-member-info">
                                                ...
                                                <p class="team-member-text" style="line-height: 1.6;text-align: justify">Bicycling is a low-impact exercise. Like walking, it can increase circulation while still protecting your joints. Regular cycling can strengthen your calf muscles and promote healthy blood flow. Both traditional and stationary bikes can be used.</p>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="team-member">
                                            ...
                                            <div class="team-member-info">
                                                ...
                                                <h3>Swimming</h3>
                                                <p class="team-member-text" style="line-height: 1.6;text-align: justify">Getting into the water is often a good way of offloading all the bones and muscles, so going for a swim or even just walking in water would be beneficial.</p>
