                   ...
                   <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                      ...
                      <li class="navbar-nav dropdown">
                        ...
                        <li class="navbar-nav dropdown">
                            <a href="login.php" class="active dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-user"></i>&nbsp;&nbsp;Account<i class="fa fa-angle-down hidden-xs" aria-hidden="true"></i></a>
                            <?php if (empty($_SESSION['username']) === false) { ?>
                            <ul class="dropdown-menu">
        ...
        <section class="site-section section-quote text-center" style="border: 0px solid green">
            ...
            <div class="container" style="border: 0px solid blue"> 
                ...
                <div class="text-center">
                    ...
                    <h1 class="section-title-big">Log In</h1>

                    <p class="section-text">Already a user? Log in and start your plan to get move.</p>

                </div>
                 <div class="row" style="border: 0px solid blue" class="text-center">

                    <div class="col-md-6 col-md-offset-3" style="border: 0px solid red">

                        <div class="site-section-small text-center" style="border: 0px solid red;padding: 10px;text-align: center">

                            <form class="form-horizontal contact-form text-left" action="login.php" method="post">
                                 <?php include('error.php')?>
                                <div>
                                    <label for="loginusername">User Name <font style="color:red">*</font></label>
                                 <input class="form-control" type="text" name="loginusername" placeholder="eg. you123" value="<?php echo isset($_POST['loginusername']) ? $_POST['loginusername'] : '' ?>" required>
                                </div>
                                <div>
                                 <label for="lloginpassword">Password <font style="color:red">*</font></label>
                                 <input class="form-control" type="password" name="loginpassword" placeholder="eg. ********" value="<?php echo isset($_POST['loginpassword']) ? $_POST['loginpassword'] : '' ?>" required>
                                </div>
                               
                                 <button class="btn btn-yellow" type="submit" name="login_user" >LOG IN</button>
                            </form><!-- /.contact-form -->
                        ...
                        <button class="btn btn-yellow" onclick="window.location.href='register.php'">SIGN UP</button>
               </div>
