                    ...
                    <li class="dropdown">
                      ...
                      <li class="navbar-nav dropdown">
                        ...
                        <li class="navbar-nav dropdown">
                            ...
                            <?php if (empty($_SESSION['username']) === false) { ?>
                            <a href="#" class="active dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-user"></i>&nbsp;&nbsp;User<i class="fa fa-angle-down hidden-xs" aria-hidden="true"></i></a>
                            <ul class="dropdown-menu">
