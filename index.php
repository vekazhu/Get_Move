                    ...
                    <div class="col-sm-5 col-sm-offset-1 col-xs-6">
                        ...
                        <div class="service">
                            ...
                            <div class="service-content">
                                ...
                                <p style="line-height: 1.6;text-align: justify">Wearing comfortable shoes can effectively reduce the pressure on the feet and legs, slow down the fatigue of the lower limbs.</p>
                            </div><!-- /.service-content -->
                        ...
                        <div class="service">
                            ...
                            <div class="service-content">
                                ...
                                <p style="line-height: 1.6;text-align: justify">Obesity is one of the important reasons for increasing the burden on the body and exacerbate varicose veins, especially for people who need to stand for a long time at work. </p>
                            </div><!-- /.service-content --> 
                        ...
                        <div class="service">
                            ...
                            <div class="service-content">
                                <h4 class="service-title"> <a href="breaktime.php">Set Break Time</a></h4>
                                <p style="line-height: 1.6;text-align: justify">Taking rest breaks during work can help to prevent leg swelling or fatigue and also decrease the risks of long-term symptom such as varicose veins.</p>
                            </div><!-- /.service-content -->
                    ...
                    <div class="col-sm-5 col-xs-6">
                        ...
                        <div class="service">
                            ...
                            <div class="service-content">
                                ...
                                <p style="line-height: 1.6;text-align: justify">Exercise is one of the best ways to reduce the physical harm caused by prolonged standing and it can also play a good preventive role from the symptoms.</p>
                            </div><!-- /.service-content -->
                        ...
                        <div class="service">
                            ...
                            <div class="service-icon">
                                <a href="workplace.php"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
                            </div><!-- /.service-icon -->
                            <div class="service-content">
                                <h4 class="service-title"><a href="workplace.php">Support at work</a></h4>
                                <p style="line-height: 1.6;text-align: justify">The most effective way to prevent occupational injuries caused by prolonged standing work is to start with personal protective measures and design of the workplace.</p>
                            </div><!-- /.service-content -->
                         ...
                         <div class="service">
                            ...
                            <div class="service-content">
                                ...
                                <p style="line-height: 1.6;text-align: justify">Are you too lazy to do exercise? A weekly exercise plan can help you. We have selected exercises that can reduce symptoms of prolonged standing for you.</p>
                            </div><!-- /.service-content -->
