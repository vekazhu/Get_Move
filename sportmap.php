            ...
            <div class="container-fluid">
                ...
                <div class="main-menu" id="perfect-navbar-collapse">
                   ...
                   <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="sportmap.php">Exercise places</a></li>                   
                    </ul><!-- /.navbar-nav -->
...
<!--    <main id="main" class="site-main">-->
        ...
        <section class="site-section-small1 section-blog">


               <!-- <ol class="breadcrumb">
                    <li><a href="index.html">&nbsp;Home</a></li>
                    <li class="active">Exercise Places</li>
                    
                </ol> --> <!-- /.breadcrumb -->

    <div class="container">
        <h2 class="section-title">Choose exercise types:</h2>
