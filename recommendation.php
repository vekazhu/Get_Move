            ...
            <div class="container">
                ...
                <div class="row">
                       ...
                       <div class="col-sm-6" style="border: 0px solid red"> 
                        <img  src="assets/img/shoe1.jpg" alt="" style="padding:10px" width="100%">
                    </div>
...
;
                    <div class="col-sm-6" style="border: 0px solid blue;text-align: right"> 
                        <img  src="assets/img/execercise2.jpg" alt="" style="padding:10px" width="100%">
                            
                    </div>

                    <div class="col-sm-6" >
                        <h2 class="section-title text-left">Exercise</h2>
                        <p class="section-text" style="line-height: 1.6">Exercise is one of the best ways to reduce the physical harm caused byprolonged standing, and it can also play a good preventive role. Employeescan do some outdoor exercises on weekends and perform light exercises indoor during the rest time of the work to improve their health.</p> 
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6" style="border: 0px solid blue">
                        <img  src="assets/img/bmi_1.jpg" alt="" style="padding:10px" width="100%">
                        
                    </div>

                    <div class="col-sm-6">
                        <h2 class="section-title text-left">Healthy Weight</h2>
                        <p class="section-text" style="line-height: 1.6">Obesity is one of the important reasons for increasing the burden on the body, especially for people who need to stand for a long time at work. If your BMI index is high, then it is time for you to manage your weight.</p> 
