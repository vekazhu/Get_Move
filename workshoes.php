                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                      ...
                      <li class="navbar-nav dropdown">
                            <a href="mealplan.php" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Get-Move Plan<i class="fa fa-angle-down hidden-xs" aria-hidden="true"></i></a>
...
<section class="site-section-small section-blog">
    ...
    <!-- /.breadcrumb -->
    <div class="container2" style="height: 580px">
        <ol class="breadcrumb">
            <li><a href="index.php">Home</a></li>
        ...
        <div align="center">
        <iframe width="800" height="415" src="https://www.youtube.com/embed/61nNacLMeO4" allowfullscreen frameborder="0"></iframe>
        ...
        <div class="sidebar">
            ...
            <div>
                ...
                <div class="radio-btn">
                    ...
                    <label for="radio-btn3">Hospitality Jobs</label>
                </div>
            </div>
